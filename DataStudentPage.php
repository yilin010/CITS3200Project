...
function selectedOption() {
    ...
    // var selectedYear = 2015;
                ...
                data: {name:studentName,cohort:selectedCohort,year:selectedYear,semester:selectedSem},
                cache: false,
                     success: function(htmltable) {
                          $('#studentsdata').html(htmltable);
                      },
                      error: function() {
                        alert("Error!");
...
<button  onclick="tablesToExcel(['studentsData'], ['Students Data'], 'Students.xls', 'Excel')">Export to Excel</button>

        <div id="studentsdata" class="col-md-20">
