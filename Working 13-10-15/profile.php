      ...
      $.ajax({
            ...
            success: function(html)
            {
                if (html.length > 0){
                    ...
                    subTable +="<th class=\"tableHead\" nowrap>First Name</th>";
                    subTable +="<th class=\"tableHead\" nowrap>Last Name</th>";
                    subTable +="</tr></thead>";
                    subTable +="<tbody>";
                    // number= 20770816;
                    ...
                    for(var j=0;j<rows;j++){
                        ...
                        for(var i=0;i<columns;i++){
                            subTable += "<td class\"classRow\" onclick=\"generateMarkers("+data[j*columns]+");\">"+data[i+j*columns]+"</td>";
                        }
                        subTable +="</tr>";
                    }
