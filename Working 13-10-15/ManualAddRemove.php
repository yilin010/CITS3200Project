<?php
    ...
    if($_POST["table"]=="Marker" || $_POST["table"]=="marker") {
        ...
        if($_POST["task"]=="Add" || $_POST["task"]=="add") {
            ...
            markerr($_POST["fname"], $_POST["lname"], FALSE, $year, $servername, $username, $password, $dbname);
        } else {
    ...
    function markerr($fName, $lName, $curr, $year, $servername, $username, $password, $dbname){
        $conn = new mysqli($servername, $username, $password, $dbname);
        if ($conn->connect_error) {
            echo "Connection failed: " . $conn->connect_error . "\r\n";
            exit(1);
