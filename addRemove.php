...
<html lang="en"><head>
    ...
    <script>
        function changeCohort(){
            ...
            // if(document.contains(manualAdd))
            //     // manualAdd.parentNode.removeChild(manualAdd);
            //     manualAdd.style.display='none';
            // if(document.contains(manualRemove))
            //     // manualRemove.parentNode.removeChild(manualRemove);
            //     manualRemove.style.display='none';
            manualAdd.innerHTML = "";
        ...
        function spawnStudent(){
            ...
            document.getElementById('insert').innerHTML="<h4 style=\"text-align:left\"><u>Add Using File</u></h4><form action=\"addFile.php\" method=\"post\" enctype=\"multipart/form-data\" accept=\".csv,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/plain\"><input type=\"file\" name=\"fileUpload\" id=\"fileUpload\"><input type=\"submit\" value=\"Upload File\" name=\"submit\">";
